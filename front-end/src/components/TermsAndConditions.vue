<template>
  <div>
    ...
    <div class="container">
      ...
      <hr>
      <p>Last updated: 27th of February, 2019</p>
      <br>
      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully
        before using the
        <b>werdz.fun</b> website (the "Service") operated by
        <b>William Cooter</b> ("us", "we",
      ...
      <p>
        ...
        controlled by us. We have no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or services. You
        further acknowledge and agree that we shall not be responsible or liable, directly
