<template>
  <div>
    ...
    <p>Last updated: February 14, 2019</p>
    <p>
      Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully
      before using the www.cooter.com website (the "Service") operated by cooter ("us", "we",
      or "our"). Your access to and use of the Service is conditioned on your acceptance of
      and compliance with these Terms. These Terms apply to all visitors, users and others who
      access or use the Service. By accessing or using the Service you agree to be bound by
    ...
    <p>
      ...
      activities or actions under your password, whether your password is with our Service or
      a third-party service. You agree not to disclose your password to any third party. You
    ...
    <p>
      ...
      controlled by cooter. cooter has no control over, and assumes no responsibility for, the
      content, privacy policies, or practices of any third party web sites or services. You
      further acknowledge and agree that cooter shall not be responsible or liable, directly
      ...
      any such web sites or services. We strongly advise you to read the terms and conditions
    ...
    <p>
      ...
      disclaimers, indemnity and limitations of liability. We may terminate or suspend your
      account immediately, without prior notice or liability, for any reason whatsoever,
      including without limitation if you breach the Terms. Upon termination, your right to
      use the Service will immediately cease. If you wish to terminate your account, you may
      simply discontinue using the Service. All provisions of the Terms which by their nature
    ...
    <p>
      ...
      Kingdom, without regard to its conflict of law provisions. Our failure to enforce any
...
<script>
// CHANGE www.cooter.com TO ACTUAL WEBSITE
// CHANGE cooter TO ACTUAL GAME NAME
